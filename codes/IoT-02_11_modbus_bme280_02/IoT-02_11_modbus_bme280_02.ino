...
// things.cat
//
// BME280 is able to read temperature, relative humidity and pressure
...
//
// It has been removed HardwareSerial modbusData(2);
// In this version has been set RS485 half duplex mode: uart_set_mode(uart_num, UART_MODE_RS485_HALF_DUPLEX);
// UART2 pins(TX: IO17, RX: IO16, RTS: IO33, CTS: NC)
// UART2 is controlling directly SSerialTxControl: uart_set_pin(uart_num, TX_MODBUS, RX_MODBUS, SSerialTxControl, UART_PIN_NO_CHANGE);

// Modified by Jordi Binefa in 20220822
